...
public class RestExceptionHandler {
  ...
  /**
   * 处理因客户端请求头中指定的 MIME Content-Type 不符合 API 要求而引发的异常。
   *
  ...
  public ResponseEntity<ErrorResponse> handleException(
    ...
    return handleApiException(new ApiException(
      ...
      StrUtil.format("不支持的 MIME Content-Type [{}: {}]", HttpHeaders.CONTENT_TYPE, contentType),
      e
    ));
  }

  /**
   * 处理因客户端请求方法不符合 API 要求而引发的异常。
   *
  ...
  public ResponseEntity<ErrorResponse> handleException(
    ...
    return handleApiException(new ApiException(
      ...
      StrUtil.format("不支持的请求方法 [{}]", req.getMethod()),
      e
    ));
  }

  /**
   * 处理服务端因无法解析客户端的请求体内容而引发的异常。
   *
   * @param e {@link HttpMessageConversionException}
   * @return 自定义 API 错误结果
   */
  @ExceptionHandler(HttpMessageConversionException.class)
  public ResponseEntity<ErrorResponse> handleException(final HttpMessageConversionException e) {
    return handleApiException(new ApiException(
  ...
  public ResponseEntity<ErrorResponse> handleException(final MissingServletRequestParameterException e) {
  ...
  /**
   * 处理因客户端请求参数无法解析为 Controller 方法参数所定义的类型而引发的异常。
   *
  ...
  private static String joinErrors(final List<String> errors) {
